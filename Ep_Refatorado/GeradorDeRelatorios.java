...
public class GeradorDeRelatorios {
    ...
    public GeradorDeRelatorios(Produto[] produto, Algoritmo alg, Ordenacao ord, Filter flt, Object argFiltro){
        
        this.produtos = new Produto[produto.length];
        for(int i = 0; i < produto.length; i++){
            this.produtos[i] = produto[i];
        }
    ...
    public void geraRelatorio(String arquivoSaida) throws IOException {
        int fim = this.produtos.length - 1;
        this.alg.ordena(this.produtos,0, fim, this.ord);
        ...
        for (int i = 0; i < produtos.length; i++) {
            ...
            if(this.flt.compara(this.argFiltro, p)) {
    ...
    public static Produto[] carregaProdutos() {
        ...
        return new Produto[]{
            new Negrito(new ProdutoPadrao(1, "O Hobbit", "Livros", 2, 34.90)),
            new Italico(new ProdutoPadrao(2, "Notebook Core i7", "Informatica", 5, 1999.90)),
            new Negrito(new Italico(new ProdutoPadrao(3, "Resident Evil 4", "Games", 7, 79.90))),
            new Negrito(new ProdutoPadrao(4, "iPhone", "Telefonia", 8, 4999.90)),
            new Italico (new ProdutoPadrao(5, "Calculo I", "Livros", 20, 55.00)),
            new Red(new ProdutoPadrao(6, "Power Glove", "Games", 3, 499.90)),
            new Red(new Negrito(new ProdutoPadrao(7, "Microsoft HoloLens", "Informatica", 1, 19900.00))),
            new Red(new Italico(new ProdutoPadrao(8, "OpenGL Programming Guide", "Livros", 4, 89.90))),
            new Red(new Negrito(new Italico(new ProdutoPadrao(9, "Vectrex", "Games", 1, 799.90)))),
            new Blue(new ProdutoPadrao(10, "Carregador iPhone", "Telefonia", 15, 499.90)),
            new Green(new ProdutoPadrao(11, "Introduction to Algorithms", "Livros", 7, 315.00)),
    ...
    public static void main(String[] args) {
        ...
        Algoritmo alg = new InsertionSort();
        Ordenacao ord = new Preco_Decresc();
        Filter flt = new Menor_Igual();
        
        GeradorDeRelatorios gdr;      
        gdr = new GeradorDeRelatorios(produtos, alg, ord, flt, 1000000);
